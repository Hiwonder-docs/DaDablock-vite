...
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.BivuVAYB.js"), true ? __vite__mapDeps([0,1]) : void 0));
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function injectVersionSwitcher() {
      ...
      const versions = ["latest", "standard-kit", "advanced-kit", "ultimate-kit"];
      const labels = {
        "latest": "Latest",
        "standard-kit": "Standard Kit",
        "advanced-kit": "Advanced Kit",
        "ultimate-kit": "Ultimate Kit"
      };
      let current = "latest";
  ...
  `;
      ...
      li.querySelectorAll(".version-switcher__item").forEach((item) => {
        item.addEventListener("click", async () => {
          ...
          const versionBase = location.pathname.split(`/en/${current}/`)[0] + `/en/${ver}/`;
          window.location.href = versionBase;
        });
      });
