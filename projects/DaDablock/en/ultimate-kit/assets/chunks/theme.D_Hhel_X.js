const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/chunks/VPLocalSearchBox.DXqEQjIh.js","assets/chunks/framework.D-P9Ptdo.js"])))=>i.map(i=>d[i]);
...
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const VPLocalSearchBox = defineAsyncComponent(() => __vitePreload(() => import("./VPLocalSearchBox.DXqEQjIh.js"), true ? __vite__mapDeps([0,1]) : void 0));
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function injectVersionSwitcher() {
      ...
      const versions = ["latest", "starter-kit", "advanced-kit", "ultimate-kit"];
      const labels = {
        "latest": "Latest",
